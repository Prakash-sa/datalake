...
The current Electron process loads `http://localhost:3000`, but nothing starts a production Next.js server inside the packaged application. Consequently, a built installer will normally open a blank or failed page. See [main.js](</Users/prakashsaini/Documents/Projects/Data Engineer/datalake-project/rag-query-engine/frontend/electron/main.js:4>).

The frontend also calls a fixed backend at `http://localhost:8000`, but Electron does not package, start, monitor, or stop that backend. See [page.tsx](</Users/prakashsaini/Documents/Projects/Data Engineer/datalake-project/rag-query-engine/frontend/app/page.tsx:81>).
...
- Tests are commented out in [requirements.txt](</Users/prakashsaini/Documents/Projects/Data Engineer/datalake-project/rag-query-engine/backend/requirements.txt:27>).
