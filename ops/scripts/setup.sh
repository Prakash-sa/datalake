...
chmod +x "$PROJECT_DIR"/ops/scripts/*.sh
...
echo -e "  2. Start services:  ${BLUE}./ops/scripts/start.sh${NC}"
echo -e "  3. Check health:    ${BLUE}./ops/scripts/health-check.sh${NC}"
echo ""
