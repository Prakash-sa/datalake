...
### Backend (apps/rag-query-engine/backend/)
...
### Airflow DAG (infra/airflow/dags/)
...
### Frontend (apps/rag-query-engine/frontend/)
...
### Code (VERIFIED)
- ✅ `apps/rag-query-engine/backend/` - FastAPI + RAG
- ✅ `apps/rag-query-engine/frontend/` - Next.js UI
- ✅ `infra/airflow/dags/rag_vector_db_ingestion_dag.py` - 6-task pipeline
